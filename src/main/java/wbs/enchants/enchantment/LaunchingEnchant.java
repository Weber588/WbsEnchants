...
public class LaunchingEnchant extends WbsEnchantment {
    ...
    public static final double SPEED_PER_LEVEL = 0.6;
    public static final double COOLDOWN_SECONDS = 5;
    ...
    public void onStartGliding(EntityToggleGlideEvent event) {
        ...
        if (highestEnchanted != null) {
            ...
            if (CooldownManager.newCooldown(player, (int) (COOLDOWN_SECONDS * Ticks.TICKS_PER_SECOND), COOLDOWN) ||
                    location.getWorld().rayTraceBlocks(location, new Vector(0, -1, 0), 5) != null
            ) {
                ...
                ((CraftPlayer) player).getHandle().connection.send(
                        new ClientboundExplodePacket(
                                ...
                                Optional.of(new Vec3(0, level * SPEED_PER_LEVEL, 0)),
                                ParticleTypes.CLOUD,
