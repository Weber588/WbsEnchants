...
public class BloomingEnchant extends WbsEnchantment implements TickableEnchant {
    ...
    static {
        ...
        FLOWER_POWERS.put(BlockTypeKeys.OPEN_EYEBLOSSOM, DEFAULT_SMALL_FLOWER_POWER * 2);
        FLOWER_POWERS.put(BlockTypeKeys.POTTED_OPEN_EYEBLOSSOM, DEFAULT_FLOWER_POT_POWER * 2);
        FLOWER_POWERS.put(BlockTypeKeys.CLOSED_EYEBLOSSOM, DEFAULT_SMALL_FLOWER_POWER * 1.5);
        FLOWER_POWERS.put(BlockTypeKeys.POTTED_CLOSED_EYEBLOSSOM, DEFAULT_FLOWER_POT_POWER * 1.5);

        FLOWER_POWERS.put(BlockTypeKeys.PITCHER_PLANT, DEFAULT_LARGE_FLOWER_POWER * 5);

        FLOWER_POWERS.put(BlockTypeKeys.GOLDEN_DANDELION, DEFAULT_SMALL_FLOWER_POWER * 2);
        FLOWER_POWERS.put(BlockTypeKeys.POTTED_GOLDEN_DANDELION, DEFAULT_FLOWER_POT_POWER * 2);
